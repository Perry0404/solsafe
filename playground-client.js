// Solana Playground Test Script - Working Version
...
// Use the workspace program (Playground will provide this)
const program = anchor.workspace.SolsafeProgram;

if (!program) {
  console.error("❌ ERROR: Program not loaded. Make sure the project is built.");
  process.exit(1);
}
